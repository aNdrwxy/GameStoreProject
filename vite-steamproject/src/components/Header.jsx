...
export function Header() {
    ...
    return (
        <div className="header">
            <div>
                <Link to="/shop"><img className="img_header" src="https://store.fastly.steamstatic.com/public/shared/images/header/logo_steam.svg?t=962016" alt="Logo Steam" /></Link>
            </div>
                ...
                {perfil ? (
                    ...
                    {menuAbierto && (
                        <div className="menu-dropdown">
                            ...
                            <div onClick={() => setMenuAbierto(false)}><Link to={`/profile/${perfil.id}/edit`}>✏️ Editar perfil</Link></div>
